...
Public Function FolderBrowser_Select(ByRef vInitDirectory As String, Optional vOwnerHwnd As Long = 0, Optional vTitle As String = vbNullString) As String
    Dim dlg As CFolderBrowser
    Set dlg = New CFolderBrowser
    dlg.InitDirectory = vInitDirectory
    dlg.Title = vbNullString
    If vOwnerHwnd <> 0 Then dlg.Owner = vOwnerHwnd
    FolderBrowser_Select = dlg.Browse
    Set dlg = Nothing
End Function
