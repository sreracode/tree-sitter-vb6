...
Public Sub TextBoxScroll(ByRef vTextBox As Control, Optional vToTop As Boolean = False)
On Error Resume Next
If vToTop Then
SendMessage vTextBox.hwnd, EM_SCROLL, SB_TOP, 0
Else
SendMessage vTextBox.hwnd, EM_SCROLL, SB_BOTTOM, 0
End If
End Sub
...
Public Function ComboxItemsToString(vCombox As Control) As String
    ...
    Do While I < C
        ...
        I = I + 1
    Loop
    If ComboxItemsToString <> vbNullString Then ComboxItemsToString = Mid$(ComboxItemsToString, Len(vbBack) + 1)
End Function
