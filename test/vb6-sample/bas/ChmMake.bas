...
chmContent(i) = chmContent(i) + "           <param name=" + Chr(34) + "Name" + Chr(34) + " value=" + Chr(34) + links(i, 1) + Chr(34) + ">" + Chr(13) + Chr(10)
chmContent(i) = chmContent(i) + "           <param name=" + Chr(34) + "Local" + Chr(34) + " value=" + Chr(34) + links(i, 0) + Chr(34) + ">" + Chr(13) + Chr(10)
