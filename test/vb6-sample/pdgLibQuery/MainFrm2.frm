...
.Add lblAuthor, SF_CAPTION, , True
.Add lblSS, SF_CAPTION, , True
.Add lblDate, SF_CAPTION, , True
...
Private Sub Form_Resize()
    ...
    With frmProcess
        ...
        lblTitle.Left = lblSSReader.Left
        txtTitle.Left = lblTitle.Left + lblTitle.Width + 120
        
        w = .Width - lblTitle.Width - lblAuthor.Width - cboLib.Width - 6 * 120
        txtTitle.Width = w / 2 '.Width - txtTitle.Left - cboLib.Width - cmdCTSearch.Width - cmdStop.Width - 4 * 120
        
        lblAuthor.Left = txtTitle.Left + txtTitle.Width + 120
        
        txtAuthor.Left = lblAuthor.Left + lblAuthor.Width + 120
        
        txtAuthor.Width = w / 2
        
        cboLib.Left = txtAuthor.Left + txtAuthor.Width + 120
        
        w = .Width - lblSS.Width - lblDate.Width - cmdCTSearch.Width - cmdStop.Width - 7 * 120
        
        lblSS.Left = lblSSReader.Left
        txtSS.Left = lblSS.Left + lblSS.Width + 120
        txtSS.Width = w / 2
        
        lblDate.Left = txtSS.Left + txtSS.Width + 120
        txtDate.Left = lblDate.Left + lblDate.Width + 120
        txtDate.Width = w / 2
        
        cmdCTSearch.Left = txtDate.Left + txtDate.Width + 120
...
.txtInfo(7) = Item.ListSubItems(8).Text
