//! This crate provides TreeSitterVb6 language support for the [tree-sitter] parsing library.
//!
...
//! let language = tree_sitter_vb6::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading TreeSitterVb6 parser");
